      ...
      <StyledDivForWrapper>
        <StyledDivForMint className="mint-section">
          <StyledDivForMint className="mint-action">
            <Text variant="primary" css={{ paddingBottom: '$4', marginTop: '$4'}}>
            ...
            <StyledElementForCard kind="wrapper" css={{ marginTop: '$4', marginBottom: '$8'}}>
            ...
            <StyledContainer>
              <Button size="large" /*onClick={onBuy}*/>Coming Soon!
              </Button>
            </StyledContainer>
          </StyledDivForMint>
